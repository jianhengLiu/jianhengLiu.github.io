...
<a href="https://github.com/hku-mars/GS-SDF">GS-SDF</a>
...
<a href="https://github.com/hku-mars/M2Mapping.git">M2Mapping</a>
...
<iframe width="354px" height="225px" src="https://player.bilibili.com/player.html?aid=912450927&cid=1167555130&page=1&as_wide=0&high_quality=1" scrolling="no" border="0" frameborder="0" framespacing="0"> </iframe><br/>
    <a href="https://github.com/HITSZ-NRSL/RIM">RIM</a>
    {% include github-stars.html repo="HITSZ-NRSL/RIM" %}
    {% include citations.html key="rim" %}
    | <a href="https://www.bilibili.com/video/BV1BJ4m1V778/?share_source=copy_web&vd_source=98e0b0102bbc355156eba6f968dc7cfb">Bilibili</a> | <a href="https://youtu.be/OZDNp90_DLE?si=1AvKupCzvtvn1aQ8">Youtube</a>
...
<img src="../Projects/misc/lvisam_putn.gif"/><br/>
    <a href="https://github.com/jianhengLiu/LVI-SAM-LIVOX">LVI-SAM-LIVOX</a>
    {% include github-stars.html repo="jianhengLiu/LVI-SAM-LIVOX" %}
    | <a href="https://github.com/jianhengLiu/PUTN">PUTN</a>
    {% include github-stars.html repo="jianhengLiu/PUTN" %}
...
<a href="https://github.com/HITSZ-NRSL/Dynamic-VINS.git">Dynamic-VINS</a>
{% include github-stars.html repo="HITSZ-NRSL/Dynamic-VINS" %}
{% include citations.html key="dynamic-vins" %}
| <a href="https://www.bilibili.com/video/BV1bF411t7mx">Bilibili</a> | <a href="https://youtu.be/y0U1IVtFBwY">Youtube</a>
...
{% include github-stars.html repo="jianhengLiu/SV-SLAM" %}
...
{% include github-stars.html repo="jianhengLiu/quad_controller_SE3" %}
...
{% include github-stars.html repo="jianhengLiu/BezierTrajGenerator" %}
| <a href="https://github.com/jianhengLiu/MinimumSnapTrajGenerator">MinimumSnapTrajGenerator</a>
{% include github-stars.html repo="jianhengLiu/MinimumSnapTrajGenerator" %}
| <a href="https://github.com/jianhengLiu/MapManager">MapManager</a>
{% include github-stars.html repo="jianhengLiu/MapManager" %}
...
{% include github-stars.html repo="jianhengLiu/FlightController" %}
...
{% include github-stars.html repo="jianhengLiu/CoppeliaSim_Steeringwheel_Tutorial" %}
...
{% include github-stars.html repo="jianhengLiu/Manipulator_GUI" %}
