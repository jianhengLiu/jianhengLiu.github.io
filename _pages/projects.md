...
<p class="project-links">
  <a href="https://github.com/jianhengLiu/LVI-SAM-LIVOX">LVI-SAM-LIVOX</a>{% include github-stars.html repo="jianhengLiu/LVI-SAM-LIVOX" %}
  <a href="https://github.com/jianhengLiu/PUTN">PUTN</a>{% include github-stars.html repo="jianhengLiu/PUTN" %}
</p>
...
基于贝塞尔曲线以及基于最小化snap的移动机器人轨迹规划算法，同时开发了二维地图管理工具用于算法验证及可视化
<br/>
<img src="../Projects/misc/bezier.png"/><br/>
<p class="project-links">
  <a href="https://github.com/jianhengLiu/BezierTrajGenerator">BezierTrajGenerator</a>{% include github-stars.html repo="jianhengLiu/BezierTrajGenerator" %}
  <a href="https://github.com/jianhengLiu/MinimumSnapTrajGenerator">MinimumSnapTrajGenerator</a>{% include github-stars.html repo="jianhengLiu/MinimumSnapTrajGenerator" %}
  <a href="https://github.com/jianhengLiu/MapManager">MapManager</a>{% include github-stars.html repo="jianhengLiu/MapManager" %}
</p>
