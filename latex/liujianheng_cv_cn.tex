...
\homepage{https://jianhengliu.github.io}                         % optional, remove / comment the line if not wanted  
...
\item{\cventry{2023/09--}{机械工程（博士研究生学位）}{香港大学}{}{\textit{}}{}}
...
%     % \item \textbf{Scalable Robot-centric Implicit Mapping:} 机器人中心的隐式建图，实现大规模增量的实时隐式建图（毕业设计）。
